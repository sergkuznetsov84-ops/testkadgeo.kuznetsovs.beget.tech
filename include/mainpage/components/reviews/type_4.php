...
$APPLICATION->IncludeComponent(
	...
	[
		...
		"LOGO_CENTER" => true,
		"TOP_PART_COLUMN" => $blockTemplateOptions["ADDITIONAL_OPTIONS"]["ELEMENTS_COUNT"]["VALUE"]==3,
		"SUBTITLE" => "Реальные отзывы (Яндекс.Карты и 2ГИС, февраль 2026)",
		"SHOW_PREVIEW_TEXT" => "N",
