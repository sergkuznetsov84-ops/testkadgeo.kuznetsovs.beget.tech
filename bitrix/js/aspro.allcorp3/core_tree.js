 ...
 * @return {boolean}
 */
BX.AsTreeCondCtrlAtom = function(parentContainer, state, arParams)
{
 ...
 * @return {boolean}
 */
BX.AsTreeCondCtrlAtom.prototype.Init = function()
{
	if (this.boolResult)
	{
...
BX.AsTreeCondCtrlAtom.prototype.IsValue = function()
{
	return (this.valuesContainer[this.id] && this.valuesContainer[this.id].length > 0);
};

BX.AsTreeCondCtrlAtom.prototype.InitValue = function()
{
	return this.IsValue();
};

BX.AsTreeCondCtrlAtom.prototype.ReInitValue = function(controls)
{
...
BX.AsTreeCondCtrlAtom.prototype.SetValue = function()
{
	return this.IsValue();
};

BX.AsTreeCondCtrlAtom.prototype.View = function(boolShow)
{

};

BX.AsTreeCondCtrlAtom.prototype.onChange = function()
{
	this.SetValue();
	this.View(false);
};

BX.AsTreeCondCtrlAtom.prototype.onKeypress = function(e)
{
	if (!e)
	{
		e = window.event;
...
BX.AsTreeCondCtrlAtom.prototype.onClick = function()
{
	this.InitValue();
	this.View(true);
};

BX.AsTreeCondCtrlAtom.prototype.Delete = function()
{
	if (this.type !== 'string')
	{
		if (this.link)
 ...
 * @return {boolean}
 */
BX.AsTreeCondCtrlAtom.prototype.CreateLink = function()
{
	if (this.boolResult)
	{
		this.link = null;
...
BX.AsTreeCondCtrlAtom.prototype.prepareData = function(arData, prefix)
{
	var data = '',
		i,
		name = '',
 ...
 * @return {string}
 */
BX.AsTreeCondCtrlAtom.prototype.ViewFormat = function(value, label)
{
	return (this.showValue ? label + ' [' + value + ']' : label);
};

BX.AsTreeCondCtrlInput = function(parentContainer, state, arParams)
{
	if (BX.AsTreeCondCtrlInput.superclass.constructor.apply(this, arguments))
		this.Init();

	return this.boolResult;
};
BX.extend(BX.AsTreeCondCtrlInput, BX.AsTreeCondCtrlAtom);

BX.AsTreeCondCtrlInput.prototype.Init = function()
{
	if (this.boolResult && BX.AsTreeCondCtrlInput.superclass.Init.apply(this, arguments))
	{
		this.input = null;
...
BX.AsTreeCondCtrlInput.prototype.InitValue = function()
{
	if (BX.AsTreeCondCtrlInput.superclass.InitValue.apply(this, arguments))
	{
...
BX.AsTreeCondCtrlInput.prototype.SetValue = function()
{
	this.valuesContainer[this.id] = this.input.value;
	if (BX.AsTreeCondCtrlInput.superclass.SetValue.apply(this, arguments))
	{
		BX.adjust(this.link, {html : BX.util.htmlspecialchars(this.valuesContainer[this.id]) });
	}
	else
...
BX.AsTreeCondCtrlInput.prototype.View = function(boolShow)
{
	BX.AsTreeCondCtrlInput.superclass.View.apply(this, arguments);
	if (boolShow)
	{
...
BX.AsTreeCondCtrlInput.prototype.Delete = function()
{
	BX.AsTreeCondCtrlInput.superclass.Delete.apply(this, arguments);
	if (this.input)
	{
...
BX.AsTreeCondCtrlInput.prototype.CreateLink = function()
{
	if (BX.AsTreeCondCtrlInput.superclass.CreateLink.apply(this, arguments))
	{
...
BX.AsTreeCondCtrlBaseSelect = function(parentContainer, state, params)
{
	this.values = [];
	this.labels = [];
	...
	if (BX.AsTreeCondCtrlBaseSelect.superclass.constructor.apply(this, arguments))
	{
...
BX.extend(BX.AsTreeCondCtrlBaseSelect, BX.AsTreeCondCtrlAtom);

BX.AsTreeCondCtrlBaseSelect.prototype.Init = function()
{
	BX.AsTreeCondCtrlInput.superclass.Init.apply(this, arguments);
	return this.boolResult;
};

BX.AsTreeCondCtrlBaseSelect.prototype.setValueText = function()
{
	var titles,
		i,
		j;
...
BX.AsTreeCondCtrlBaseSelect.prototype.SetValue = function()
{
	var arText = [],
		arSelVal = [],
		i,
	...
	if (BX.AsTreeCondCtrlBaseSelect.superclass.SetValue.apply(this, arguments))
		BX.adjust(this.link, {html : BX.util.htmlspecialchars(arText.join(', ')) });
	else
		BX.adjust(this.link, {html : this.defaultText });
};

BX.AsTreeCondCtrlBaseSelect.prototype.View = function(boolShow)
{
	BX.AsTreeCondCtrlBaseSelect.superclass.View.apply(this, arguments);
	if (boolShow)
	{
		BX.style(this.link, 'display', 'none');
...
BX.AsTreeCondCtrlBaseSelect.prototype.onChange = function()
{
	this.SetValue();
	if (!this.multiple)
		this.View(false);
...
BX.AsTreeCondCtrlBaseSelect.prototype.onBlur = function()
{
	this.View(false);
};

BX.AsTreeCondCtrlBaseSelect.prototype.onKeypress = function(e)
{
	if (!e)
		e = window.event;
...
BX.AsTreeCondCtrlBaseSelect.prototype.onClick = function()
{
	this.View(true);
};

BX.AsTreeCondCtrlBaseSelect.prototype.Delete = function()
{
	BX.AsTreeCondCtrlBaseSelect.superclass.Delete.apply(this, arguments);
	if (this.select)
	{
...
BX.AsTreeCondCtrlBaseSelect.prototype.CreateLink = function()
{
	if (BX.AsTreeCondCtrlBaseSelect.superclass.CreateLink.apply(this, arguments))
		BX.bind(this.link, 'click', BX.proxy(this.onClick, this));

	return this.boolResult;
};

BX.AsTreeCondCtrlBaseSelect.prototype.CreateSelect = function()
{
	var props;
...
BX.AsTreeCondCtrlSelect = function(parentContainer, state, arParams)
{
	var i;
	if (BX.AsTreeCondCtrlSelect.superclass.constructor.apply(this, arguments))
	{
...
BX.extend(BX.AsTreeCondCtrlSelect, BX.AsTreeCondCtrlBaseSelect);

BX.AsTreeCondCtrlSelect.prototype.Init = function()
{
	var i;

	if (this.boolResult && BX.AsTreeCondCtrlSelect.superclass.Init.apply(this, arguments))
	{
		this.CreateSelect();
		if (BX.type.isElementNode(this.select))
		{
...
BX.AsTreeCondCtrlSelect.prototype.InitValue = function()
{
	if (BX.AsTreeCondCtrlSelect.superclass.InitValue.apply(this, arguments))
		this.setValueText();
	else
		this.select.selectedIndex = -1;
};

BX.AsTreeCondCtrlSelect.prototype.CreateLink = function()
{
	if (BX.AsTreeCondCtrlSelect.superclass.CreateLink.apply(this, arguments))
		BX.bind(this.link, 'click', BX.proxy(this.onClick, this));
 ...
 * @return {boolean}
 */
BX.AsTreeCondCtrlLazySelect = function(parentContainer, state, params)
{
	var i;
	...
	if (BX.AsTreeCondCtrlLazySelect.superclass.constructor.apply(this, arguments))
	{
...
BX.extend(BX.AsTreeCondCtrlLazySelect, BX.AsTreeCondCtrlBaseSelect);

BX.AsTreeCondCtrlLazySelect.prototype.Init = function()
{
	if (this.boolResult && BX.AsTreeCondCtrlLazySelect.superclass.Init.apply(this, arguments))
	{
		this.CreateSelect();
		this.InitValue();
	}
...
BX.AsTreeCondCtrlLazySelect.prototype.InitValue = function()
{
	if (BX.AsTreeCondCtrlLazySelect.superclass.InitValue.apply(this, arguments))
	{
		if (!this.loaded)
...
BX.AsTreeCondCtrlLazySelect.prototype.ajaxLoad = function(source)
{
	var ajaxParams = {},
		i,
		successFunc;
...
BX.AsTreeCondCtrlLazySelect.prototype.ajaxLoadResult = function(result)
{
	var i;
...
BX.AsTreeCondCtrlLazySelect.prototype.ajaxLoadResultFromInit = function(result)
{
	if (BX.type.isArray(result))
	{
...
BX.AsTreeCondCtrlLazySelect.prototype.ajaxLoadResultFromClick = function(result)
{
	if (BX.type.isArray(result))
	{
		this.ajaxLoadResult(result);
...
BX.AsTreeCondCtrlLazySelect.prototype.onClick = function()
{
	if (this.loaded)
		this.View(true);
	else
 ...
 * @return {boolean}
 */
BX.AsTreeCondCtrlPopup = function(parentContainer, state, arParams)
{
	var i;

	if (BX.AsTreeCondCtrlPopup.superclass.constructor.apply(this, arguments))
	{
...
BX.extend(BX.AsTreeCondCtrlPopup, BX.AsTreeCondCtrlAtom);

BX.AsTreeCondCtrlPopup.prototype.Init = function()
{
	if (this.boolResult && BX.AsTreeCondCtrlPopup.superclass.Init.apply(this, arguments))
	{
...
BX.AsTreeCondCtrlPopup.prototype.CreateLink = function()
{
	if (this.boolResult)
	{
		this.link = this.parentContainer.appendChild(BX.create(
...
BX.AsTreeCondCtrlPopup.prototype.PopupShow = function()
{
...
BX.AsTreeCondCtrlPopup.prototype.onChange = function()
{
	this.valuesContainer[this.id] = this.input.value;
};

BX.AsTreeCondCtrlPopup.prototype.Delete = function()
{
	BX.AsTreeCondCtrlPopup.superclass.Delete.apply(this, arguments);
	if (this.input)
	{
		BX.unbindAll(this.input);
		this.input = BX.remove(this.input);
...
BX.AsTreeUserCondCtrlPopup = function(parentContainer, state, arParams)
{
	var i;

	if (BX.AsTreeUserCondCtrlPopup.superclass.constructor.apply(this, arguments))
	{
		if (!arParams.popup_url)
		{
			return this.boolResult;
...
BX.extend(BX.AsTreeUserCondCtrlPopup, BX.AsTreeCondCtrlPopup);

BX.AsTreeUserCondCtrlPopup.prototype.Init = function()
{
	var i;
	...
	if (this.boolResult && BX.AsTreeUserCondCtrlPopup.superclass.Init.apply(this, arguments))
	{
		if (this.input)
		{
			BX.unbindAll(this.input);
...
BX.AsTreeUserCondCtrlPopup.prototype.CreateLink = function()
{
...
BX.AsTreeUserCondCtrlPopup.prototype.AppendItemNode = function(value, label)
{
...
BX.AsTreeUserCondCtrlPopup.prototype.AppendInputNode = function(id, name, value)
{
...
BX.AsTreeUserCondCtrlPopup.prototype.AppendFakeInputNode = function(id, name)
{
	this.inputs.push(this.parentContainer.appendChild(BX.create(
		'INPUT',
		{
...
BX.AsTreeUserCondCtrlPopup.prototype.onChangeFake = function(params)
{
...
BX.AsTreeUserCondCtrlPopup.prototype.onSave = function(params)
{
...
BX.AsTreeUserCondCtrlPopup.prototype.DeleteItem = function(e)
{
...
BX.AsTreeUserCondCtrlPopup.prototype.Delete = function()
{
	BX.AsTreeUserCondCtrlPopup.superclass.Delete.apply(this, arguments);
	if (this.input)
	{
		BX.unbindAll(this.input);
		this.input = BX.remove(this.input);
...
BX.AsTreeCondCtrlDialog = function(parentContainer, state, arParams)
{
	var data;

	if (BX.AsTreeCondCtrlDialog.superclass.constructor.apply(this, arguments))
	{
...
BX.extend(BX.AsTreeCondCtrlDialog, BX.AsTreeCondCtrlPopup);

BX.AsTreeCondCtrlDialog.prototype.CreateLink = function()
{
	if (this.boolResult)
	{
		this.link = this.parentContainer.appendChild(BX.create(
...
BX.AsTreeCondCtrlDialog.prototype.onChange = function()
{
	this.valuesContainer[this.id] = this.input.value;
};

BX.AsTreeCondCtrlDialog.prototype.DialogShow = function()
{
	if (this.dialog !== null)
		this.dialog = null;
...
BX.AsTreeCondCtrlDialog.prototype.onSave = function(params)
{
...
BX.AsTreeCondCtrlDialog.prototype.Delete = function()
{
	BX.AsTreeCondCtrlDialog.superclass.Delete.apply(this, arguments);
	if (this.input)
	{
		BX.unbindAll(this.input);
		this.input = BX.remove(this.input);
...
BX.AsTreeMultiCondCtrlDialog = function(parentContainer, state, arParams)
{
	this.defaultLabel = null;
	var data;

	if (BX.AsTreeMultiCondCtrlDialog.superclass.constructor.apply(this, arguments))
	{
		this.popup_params.event = 'onTreeCondDialogSave';
...
BX.extend(BX.AsTreeMultiCondCtrlDialog, BX.AsTreeCondCtrlPopup);

BX.AsTreeMultiCondCtrlDialog.prototype.AppendItemNode = function(value, label)
{
	this.link.insertBefore(BX.create(
			'SPAN',
			{
...
BX.AsTreeMultiCondCtrlDialog.prototype.AppendInputNode = function(id, name, value)
{
	this.inputs.push(this.parentContainer.appendChild(BX.create(
		'INPUT',
		{
...
BX.AsTreeMultiCondCtrlDialog.prototype.Init = function()
{
	var i;
	...
	if (this.boolResult && BX.AsTreeMultiCondCtrlDialog.superclass.Init.apply(this, arguments))
	{
		if (this.input)
		{
			BX.unbindAll(this.input);
...
BX.AsTreeMultiCondCtrlDialog.prototype.CreateLink = function()
{
	var i;
...
BX.AsTreeMultiCondCtrlDialog.prototype.onChange = function()
{
};

BX.AsTreeMultiCondCtrlDialog.prototype.DialogShow = function()
{
	if (this.dialog !== null)
		this.dialog = null;
	this.dialog = new BX.CAdminDialog({
...
BX.AsTreeMultiCondCtrlDialog.prototype.onSave = function(params)
{
	if (BX.type.isPlainObject(params))
	{
		this.AppendInputNode(this.parentContainer.id+'_'+this.id, this.name+'[]', params.id);
...
BX.AsTreeMultiCondCtrlDialog.prototype.DeleteItem = function(e)
{
	var srcElement = e.target || e.srcElement;
	if(!srcElement)
	{
...
BX.AsTreeMultiCondCtrlDialog.prototype.Delete = function()
{
	BX.AsTreeMultiCondCtrlDialog.superclass.Delete.apply(this, arguments);
	if (this.input)
	{
		BX.unbindAll(this.input);
		this.input = BX.remove(this.input);
...
BX.AsTreeCondCtrlDateTime = function(parentContainer, state, arParams)
{
	if (BX.AsTreeCondCtrlDateTime.superclass.constructor.apply(this, arguments))
	{
...
BX.extend(BX.AsTreeCondCtrlDateTime, BX.AsTreeCondCtrlAtom);

BX.AsTreeCondCtrlDateTime.prototype.Init = function()
{
	if (this.boolResult && BX.AsTreeCondCtrlDateTime.superclass.Init.apply(this, arguments))
	{
...
BX.AsTreeCondCtrlDateTime.prototype.InitValue = function()
{
	if (BX.AsTreeCondCtrlDateTime.superclass.InitValue.apply(this, arguments))
	{
		BX.adjust(this.link, {html : BX.util.htmlspecialchars(this.valuesContainer[this.id]) });
		this.input.value = this.valuesContainer[this.id];
	}
...
BX.AsTreeCondCtrlDateTime.prototype.SetValue = function()
{
	this.valuesContainer[this.id] = this.input.value;
	if (BX.AsTreeCondCtrlDateTime.superclass.SetValue.apply(this, arguments))
	{
		BX.adjust(this.link, {html : BX.util.htmlspecialchars(this.valuesContainer[this.id]) });
	}
	else
...
BX.AsTreeCondCtrlDateTime.prototype.View = function(boolShow)
{
	BX.AsTreeCondCtrlDateTime.superclass.View.apply(this, arguments);
	if (boolShow)
	{
		BX.style(this.link, 'display', 'none');
...
BX.AsTreeCondCtrlDateTime.prototype.Delete = function()
{
	BX.AsTreeCondCtrlDateTime.superclass.Delete.apply(this, arguments);
	if (!!this.input)
	{
		BX.unbindAll(this.input);
		this.input = BX.remove(this.input);
...
BX.AsTreeCondCtrlDateTime.prototype.CreateLink = function()
{
	if (BX.AsTreeCondCtrlDateTime.superclass.CreateLink.apply(this, arguments))
	{
		BX.bind(this.link, 'click', BX.proxy(this.onClick, this));
	}
	return this.boolResult;
...
BX.AsTreeCondCtrlDateTime.prototype.ShowCalendarControl = function()
{
	if (!!this.calendarText)
	{
		BX.calendar({
...
BX.AsTreeConditions = function(arParams, obTree, obControls)
{
	var i;
	...
	this.AtomTypes = {
		'prefix': BX.AsTreeCondCtrlAtom,
		'input': BX.AsTreeCondCtrlInput,
		'select': BX.AsTreeCondCtrlSelect,
		'lazySelect': BX.AsTreeCondCtrlLazySelect,
		'popup': BX.AsTreeCondCtrlPopup,
		'userPopup': BX.AsTreeUserCondCtrlPopup,
		'datetime': BX.AsTreeCondCtrlDateTime,
		'dialog': BX.AsTreeCondCtrlDialog,
		'multiDialog': BX.AsTreeMultiCondCtrlDialog
	};
...
BX.AsTreeConditions.prototype.Delete = function()
{
	if (this.tree)
	{
 ...
 * @return {boolean|{}}
 */
BX.AsTreeConditions.prototype.ControlSearch = function(controlId)
{
 ...
 * @return {boolean|{}}
 */
BX.AsTreeConditions.prototype.ControlInGrpSearch = function(controls, controlId)
{
	var curControl = false,
		i;
...
BX.AsTreeConditions.prototype.RenderTree = function()
{
	if (this.boolResult)
	{
...
BX.AsTreeConditions.prototype.RenderLevel = function(parentContainer, obParent, obTreeLevel, obParams)
{
	var CurControl,
		strContClassName,
		wrapper = null,
	...
	if (this.boolResult)
	{
		...
		if (!obTreeLevel.fatal_err_cond)
		{
			...
			for (i = 0; i < CurControl.control.length; i++)
			{
				...
				{
					elem = new BX.AsTreeCondCtrlAtom(div, obTreeLevel, item);
				}
			}
...
BX.AsTreeConditions.prototype.CreateLevel = function(obTreeLevel, controlId, num)
{
	var indexPrev,
		intCurrentIndex,
		obLogicParams;
...
BX.AsTreeConditions.prototype.SearchForDeleteLevel = function(obTreeLevel, obParent)
{
	var arRes = {
			indexDel: -1,
			indexPrev: -1
 ...
 * @return {number}
 */
BX.AsTreeConditions.prototype.SearchForCreateLogic = function(obTreeLevel, indexCurrent)
{
	var indexPrev = -1,
		j;
	if (!!obTreeLevel && !!obTreeLevel.children)
...
BX.AsTreeConditions.prototype.DeleteLevel = function(obTreeLevel, obParent)
{
	var j,
		arDel;
...
BX.AsTreeConditions.prototype.RenderCreateBtn = function(obTreeLevel, CurControl)
{
	var divAdd,
		addBtn,
		addSelect,
...
BX.AsTreeConditions.prototype.RenderCreateOneActionBtn = function(obTreeLevel, CurControl)
{
...
BX.AsTreeConditions.prototype.RenderDeleteBtn = function(obTreeLevel, obParent, currentControl)
{
	var delBtn;
...
BX.AsTreeConditions.prototype.CreateLogic = function(obTreeLevel, obParent, obParams)
{
	var logic,
		strClass;
...
BX.AsTreeConditions.prototype.DeleteLogic = function(obTreeLevel)
{
...
BX.AsTreeConditions.prototype.UpdateLogic = function(obTreeLevel, obParams)
{
	var strClass;
 ...
 * @return {number}
 */
BX.AsTreeConditions.prototype.SearchVisual = function(obTreeLevel)
{
...
BX.AsTreeConditions.prototype.ChangeVisual = function(obTreeLevel)
{
	var intCurrentIndex,
		obParams,
		j;
...
BX.AsTreeConditions.prototype.NextVisual = function(obTreeLevel)
{
	var intCurrentIndex,
		arValues,
		i, j,
