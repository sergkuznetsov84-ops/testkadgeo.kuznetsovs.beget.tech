function initAsproAllcorp3ModalConditionsControl(params)
{
	var data = JSON.parse(params.data);
	if (data)
	{
		window['aspro_Allcorp3_modalconditions_conditions_' + params.propertyID] = new AsproAllcorp3ModalConditionsControl(data, params);
	}
}

function AsproAllcorp3ModalConditionsControl(data, params)
{
...
AsproAllcorp3ModalConditionsControl.prototype =
{
	getPath: function()
	{
