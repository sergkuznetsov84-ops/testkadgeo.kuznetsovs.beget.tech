...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"SET_BANNER_FROM_TYPE" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("T_SET_BANNER_FROM_TYPE"),
			"TYPE" => "CHECKBOX",
			"REFRESH" => "Y",
			"DEFAULT" => "N",
		),
		"TYPE_BANNERS_IBLOCK_ID" => Array(
			...
			"DEFAULT" => '',
			"ADDITIONAL_VALUES" => "Y",
			"HIDDEN" => ((isset($arCurrentValues['SET_BANNER_FROM_TYPE']) && $arCurrentValues['SET_BANNER_FROM_TYPE'] == 'N') || !isset($arCurrentValues['SET_BANNER_FROM_TYPE']) ? 'Y' : 'N'),
			// "REFRESH" => "Y",
		),
