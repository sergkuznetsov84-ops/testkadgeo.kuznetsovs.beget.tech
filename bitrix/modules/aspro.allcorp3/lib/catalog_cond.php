...
const MODULE_NAME = 'Allcorp3';

Loc::loadMessages(__FILE__);

define('AS_COND_LOGIC_EQ', 0);						// = (equal)
define('AS_COND_LOGIC_NOT_EQ', 1);					// != (not equal)
define('AS_COND_LOGIC_GR', 2);						// > (great)
define('AS_COND_LOGIC_LS', 3);						// < (less)
define('AS_COND_LOGIC_EGR', 4);						// => (great or equal)
define('AS_COND_LOGIC_ELS', 5);						// =< (less or equal)
define('AS_COND_LOGIC_CONT', 6);					// contain
define('AS_COND_LOGIC_NOT_CONT', 7);				// not contain

define('AS_COND_MODE_DEFAULT', 0);					// full mode
define('AS_COND_MODE_PARSE', 1);					// parsing mode
define('AS_COND_MODE_GENERATE', 2);					// generate mode
define('AS_COND_MODE_SQL', 3);						// generate getlist mode
define('AS_COND_MODE_SEARCH', 4);					// info mode

define('AS_COND_BUILD_CATALOG', 0);					// catalog conditions
define('AS_COND_BUILD_SALE', 1);					// sale conditions
define('AS_COND_BUILD_SALE_ACTIONS', 2);			// sale actions conditions
...
class CGlobalCondCtrl
{
	...
	public static function GetLogic($arOperators = false)
	{
		$arOperatorsList = array(
			AS_COND_LOGIC_EQ => array(
				...
				'MULTI_SEP' => ' || ',
				'VALUE' => 'Equal',
				'LABEL' => Loc::getMessage('AS_COND_LOGIC_EQ_LABEL')
			),
			AS_COND_LOGIC_NOT_EQ => array(
				'ID' => AS_COND_LOGIC_NOT_EQ,
				'OP' => array(
					'Y' => '!in_array(#VALUE#, #FIELD#)',
					'N' => '#FIELD# != #VALUE#'
				),
				...
				'MULTI_SEP' => ' && ',
				'VALUE' => 'Not',
				'LABEL' => Loc::getMessage('AS_COND_LOGIC_NOT_EQ_LABEL')
			),
			AS_COND_LOGIC_GR => array(
				'ID' => AS_COND_LOGIC_GR,
				'OP' => array(
					'N' => '#FIELD# > #VALUE#',
					'Y' => '\Aspro\\'.MODULE_NAME.'\CGlobalCondCtrl::LogicGreat(#FIELD#, #VALUE#)'
				),
				'VALUE' => 'Great',
				'LABEL' => Loc::getMessage('AS_COND_LOGIC_GR_LABEL')
			),
			AS_COND_LOGIC_LS => array(
				'ID' => AS_COND_LOGIC_LS,
				'OP' => array(
					'N' => '#FIELD# < #VALUE#',
					'Y' => '\Aspro\\'.MODULE_NAME.'\CGlobalCondCtrl::LogicLess(#FIELD#, #VALUE#)'
				),
				'VALUE' => 'Less',
				'LABEL' => Loc::getMessage('AS_COND_LOGIC_LS_LABEL')
			),
			AS_COND_LOGIC_EGR => array(
				'ID' => AS_COND_LOGIC_EGR,
				'OP' => array(
					'N' => '#FIELD# >= #VALUE#',
					'Y' => '\Aspro\\'.MODULE_NAME.'CGlobalCondCtrl::LogicEqualGreat(#FIELD#, #VALUE#)'
				),
				'VALUE' => 'EqGr',
				'LABEL' => Loc::getMessage('AS_COND_LOGIC_EGR_LABEL')
			),
			AS_COND_LOGIC_ELS => array(
				'ID' => AS_COND_LOGIC_ELS,
				'OP' => array(
					'N' => '#FIELD# <= #VALUE#',
					'Y' => '\Aspro\\'.MODULE_NAME.'\CGlobalCondCtrl::LogicEqualLess(#FIELD#, #VALUE#)'
				),
				'VALUE' => 'EqLs',
				'LABEL' => Loc::getMessage('AS_COND_LOGIC_ELS_LABEL')
			),
			AS_COND_LOGIC_CONT => array(
				'ID' => AS_COND_LOGIC_CONT,
				'OP' => array(
					'N' => 'false !== strpos(#FIELD#, #VALUE#)',
					'Y' => '\Aspro\\'.MODULE_NAME.'\CGlobalCondCtrl::LogicContain(#FIELD#, #VALUE#)'
				),
				'PARENT' => ' || ',
				'MULTI_SEP' => ' || ',
				'VALUE' => 'Contain',
				'LABEL' => Loc::getMessage('AS_COND_LOGIC_CONT_LABEL')
			),
			AS_COND_LOGIC_NOT_CONT => array(
				'ID' => AS_COND_LOGIC_NOT_CONT,
				'OP' => array(
					'N' => 'false === strpos(#FIELD#, #VALUE#)',
					'Y' => '\Aspro\\'.MODULE_NAME.'\CGlobalCondCtrl::LogicNotContain(#FIELD#, #VALUE#)'
				),
				'PARENT' => ' && ',
				'MULTI_SEP' => ' && ',
				'VALUE' => 'NotCont',
				'LABEL' => Loc::getMessage('AS_COND_LOGIC_NOT_CONT_LABEL')
			)
		);
	...
	public static function Check($arOneCondition, $arParams, $arControl, $boolShow)
	{
		...
		if ($boolShow)
		{
			...
			if ($strLogic === false)
			{
				$boolError = true;
				$boolFatalError = true;
				$arMsg[] = Loc::getMessage('AS_MOD_COND_ERR_CHECK_DATA_LOGIC_ABSENT');
			}
			else
			{
				...
				switch($arControl['PHP_VALUE']['VALIDATE'])
				{
					case 'element':
						...
						if ($boolMulti)
						{
							...
							{
								$boolError = true;
								$arMsg[] = Loc::getMessage('AS_MOD_COND_ERR_CHECK_DATA_ELEMENT_ABSENT_MULTI');
							}
						}
						else
						{
							...
							{
								$boolError = true;
								$arMsg[] = Loc::getMessage('AS_MOD_COND_ERR_CHECK_DATA_ELEMENT_ABSENT');
							}
						}
						break;
					case 'section':
						...
						if ($boolMulti)
						{
							...
							{
								$boolError = true;
								$arMsg[] = Loc::getMessage('AS_MOD_COND_ERR_CHECK_DATA_SECTION_ABSENT_MULTI');
							}
						}
						else
						{
							...
							{
								$boolError = true;
								$arMsg[] = Loc::getMessage('AS_MOD_COND_ERR_CHECK_DATA_SECTION_ABSENT');
							}
						}
						break;
					case 'iblock':
						if ($boolMulti)
						{
							...
							{
								$boolError = true;
								$arMsg[] = Loc::getMessage('AS_MOD_COND_ERR_CHECK_DATA_IBLOCK_ABSENT_MULTI');
							}
						}
						else
						{
							...
							{
								$boolError = true;
								$arMsg[] = Loc::getMessage('AS_MOD_COND_ERR_CHECK_DATA_IBLOCK_ABSENT');
							}
						}
						break;
					case 'enumValue':
						...
						if ($boolMulti)
						{
							...
							{
								$boolError = true;
								$arMsg[] = Loc::getMessage('AS_MOD_COND_ERR_CHECK_DATA_ENUM_VALUE_ABSENT_MULTI');
							}
							unset($checkResult);
						}
						else
						{
							...
							{
								$boolError = true;
								$arMsg[] = Loc::getMessage('AS_MOD_COND_ERR_CHECK_DATA_ENUM_VALUE_ABSENT');
							}
						}
						unset($iterator);
						break;
					case 'user':
						...
						if ($boolMulti)
						{
							...
							{
								$boolError = true;
								$arMsg[] = Loc::getMessage('AS_MOD_COND_ERR_CHECK_DATA_USER_ABSENT_MULTI');
							}
						}
						else
						{
							...
							{
								$boolError = true;
								$arMsg[] = Loc::getMessage('AS_MOD_COND_ERR_CHECK_DATA_USER_ABSENT');
							}
						}
						break;
					case 'list':
						if (isset($arControl['JS_VALUE']) && isset($arControl['JS_VALUE']['values']) && !empty($arControl['JS_VALUE']['values']))
						{
							if ($boolMulti)
							{
								...
								{
									$boolError = true;
									$arMsg[] = Loc::getMessage('AS_MOD_COND_ERR_CHECK_DATA_LIST_ABSENT_MULTI');
								}
							}
							else
							{
								...
								{
									$boolError = true;
									$arMsg[] = Loc::getMessage('AS_MOD_COND_ERR_CHECK_DATA_LIST_ABSENT');
								}
							}
						}
						else
	...
	public static function CheckAtoms($arOneCondition, $arParams, $arControl, $boolShow)
	{
		...
		if (!isset($arControl['ATOMS']) || empty($arControl['ATOMS']) || !is_array($arControl['ATOMS']))
		{
			$boolFatalError = true;
			$boolError = true;
			$arMsg[] = Loc::getMessage('AS_GLOBAL_COND_ERR_ATOMS_ABSENT');
		}
		if (!$boolError)
		{
			$boolValidate = false;
...
class CGlobalCondCtrlGroup extends CGlobalCondCtrl
{
	...
	public static function GetControlShow($arParams)
	{
		return array(
			...
			'group' => true,
			'label' => Loc::getMessage('AS_CLOBAL_COND_GROUP_LABEL'),
			'defaultText' => Loc::getMessage('AS_CLOBAL_COND_GROUP_DEF_TEXT'),
	...
	public static function GetAtoms()
	{
		return array(
			'All' => array(
				...
				'type' => 'select',
				'values' => array(
					'AND' => Loc::getMessage('AS_CLOBAL_COND_GROUP_SELECT_ALL'),
					'OR' => Loc::getMessage('AS_CLOBAL_COND_GROUP_SELECT_ANY')
				),
				'defaultText' => Loc::getMessage('AS_CLOBAL_COND_GROUP_SELECT_DEF'),
				'defaultValue' => 'AND',
				'first_option' => '...'
			),
			'True' => array(
				...
				'type' => 'select',
				'values' => array(
					'True' => Loc::getMessage('AS_CLOBAL_COND_GROUP_SELECT_TRUE'),
					'False' => Loc::getMessage('AS_CLOBAL_COND_GROUP_SELECT_FALSE')
				),
				'defaultText' => Loc::getMessage('AS_CLOBAL_COND_GROUP_SELECT_DEF'),
				'defaultValue' => 'True',
				'first_option' => '...'
		...
		return array(
			...
			'logic' => array(
				array(
					...
					'message' => Loc::getMessage('AS_CLOBAL_COND_GROUP_LOGIC_AND')
				),
				array(
					'style' => 'condition-logic-and',
					'message' => Loc::getMessage('AS_CLOBAL_COND_GROUP_LOGIC_NOT_AND')
				),
				array(
					'style' => 'condition-logic-or',
					'message' => Loc::getMessage('AS_CLOBAL_COND_GROUP_LOGIC_OR')
				),
				array(
					'style' => 'condition-logic-or',
					'message' => Loc::getMessage('AS_CLOBAL_COND_GROUP_LOGIC_NOT_OR')
				)
			)
		);
	}
...
class CCatalogCondCtrlIBlockFields extends CCatalogCondCtrlComplex
{
	...
	public static function GetControlShow($arParams)
	{
		...
		$arResult = array(
			'controlgroup' => true,
			'group' =>  false,
			'label' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_CONTROLGROUP_LABEL'),
			'showIn' => static::GetShowIn($arParams['SHOW_IN_GROUPS']),
			'children' => array()
		);
	...
	public static function GetControls($strControlID = false)
	{
		...
		$arControlList = array(
			'CondIBElement' => array(
				...
				'FIELD' => 'ID',
				'FIELD_TYPE' => 'int',
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_ELEMENT_ID_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_ELEMENT_ID_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ)),
				'JS_VALUE' => array(
					/*
					'type' => 'multiDialog',
			...
			'CondIBIBlock' => array(
				...
				'FIELD' => 'IBLOCK_ID',
				'FIELD_TYPE' => 'int',
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_IBLOCK_ID_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_IBLOCK_ID_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ)),
				'JS_VALUE' => array(
					'type' => 'popup',
					'popup_url' => self::getAdminSection().'iblock_search.php',
			...
			'CondIBSection' => array(
				...
				'FIELD' => 'SECTION_ID',
				'FIELD_TYPE' => 'int',
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_SECTION_ID_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_SECTION_ID_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ)),
				'JS_VALUE' => array(
					'type' => 'popup',
			...
			'CondIBCode' => array(
				...
				'FIELD_TYPE' => 'string',
				'FIELD_LENGTH' => 255,
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_CODE_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_CODE_PREFIX'),
			...
			'CondIBXmlID' => array(
				...
				'FIELD_TYPE' => 'string',
				'FIELD_LENGTH' => 255,
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_XML_ID_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_XML_ID_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ, AS_COND_LOGIC_CONT, AS_COND_LOGIC_NOT_CONT)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			'CondIBName' => array(
				...
				'FIELD_TYPE' => 'string',
				'FIELD_LENGTH' => 255,
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_NAME_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_NAME_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ, AS_COND_LOGIC_CONT, AS_COND_LOGIC_NOT_CONT)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			'CondIBDateActiveFrom' => array(
				...
				'FIELD_TYPE' => 'datetime',
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_DATE_ACTIVE_FROM_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_DATE_ACTIVE_FROM_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ, AS_COND_LOGIC_GR, AS_COND_LOGIC_LS, AS_COND_LOGIC_EGR, AS_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'datetime',
					'format' => 'datetime'
				),
			...
			'CondIBDateActiveTo' => array(
				...
				'FIELD_TYPE' => 'datetime',
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_DATE_ACTIVE_TO_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_DATE_ACTIVE_TO_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ, AS_COND_LOGIC_GR, AS_COND_LOGIC_LS, AS_COND_LOGIC_EGR, AS_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'datetime',
					'format' => 'datetime'
			...
			'CondIBSort' => array(
				...
				'FIELD' => 'SORT',
				'FIELD_TYPE' => 'int',
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_SORT_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_SORT_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ, AS_COND_LOGIC_GR, AS_COND_LOGIC_LS, AS_COND_LOGIC_EGR, AS_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			'CondIBPreviewText' => array(
				...
				'FIELD' => 'PREVIEW_TEXT',
				'FIELD_TYPE' => 'text',
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_PREVIEW_TEXT_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_PREVIEW_TEXT_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ, AS_COND_LOGIC_CONT, AS_COND_LOGIC_NOT_CONT)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			'CondIBDetailText' => array(
				...
				'FIELD' => 'DETAIL_TEXT',
				'FIELD_TYPE' => 'text',
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_DETAIL_TEXT_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_DETAIL_TEXT_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ, AS_COND_LOGIC_CONT, AS_COND_LOGIC_NOT_CONT)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			'CondIBDateCreate' => array(
				...
				'FIELD' => 'DATE_CREATE',
				'FIELD_TYPE' => 'datetime',
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_DATE_CREATE_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_DATE_CREATE_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ, AS_COND_LOGIC_GR, AS_COND_LOGIC_LS, AS_COND_LOGIC_EGR, AS_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'datetime',
					'format' => 'datetime'
			...
			'CondIBCreatedBy' => array(
				...
				'FIELD' => 'CREATED_BY',
				'FIELD_TYPE' => 'int',
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_CREATED_BY_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_CREATED_BY_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			'CondIBTimestampX' => array(
				...
				'FIELD' => 'TIMESTAMP_X',
				'FIELD_TYPE' => 'datetime',
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_TIMESTAMP_X_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_TIMESTAMP_X_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ, AS_COND_LOGIC_GR, AS_COND_LOGIC_LS, AS_COND_LOGIC_EGR, AS_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'datetime',
					'format' => 'datetime'
			...
			'CondIBModifiedBy' => array(
				...
				'FIELD' => 'MODIFIED_BY',
				'FIELD_TYPE' => 'int',
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_MODIFIED_BY_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_MODIFIED_BY_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			'CondIBTags' => array(
				...
				'FIELD_TYPE' => 'string',
				'FIELD_LENGTH' => 255,
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_TAGS_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_TAGS_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ, AS_COND_LOGIC_CONT, AS_COND_LOGIC_NOT_CONT)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			'CondCatQuantity' => array(
				...
				'FIELD_TYPE' => 'double',
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_CATALOG_QUANTITY_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_CATALOG_QUANTITY_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ, AS_COND_LOGIC_GR, AS_COND_LOGIC_LS, AS_COND_LOGIC_EGR, AS_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'input'
				)
			...
			'CondCatWeight' => array(
				...
				'FIELD_TABLE' => 'WEIGHT',
				'FIELD_TYPE' => 'double',
				'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_CATALOG_WEIGHT_LABEL'),
				'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_CATALOG_WEIGHT_PREFIX'),
				'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ, AS_COND_LOGIC_GR, AS_COND_LOGIC_LS, AS_COND_LOGIC_EGR, AS_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			// 	'FIELD_TABLE' => 'VAT_ID',
			// 	'FIELD_TYPE' => 'int',
			// 	'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_CATALOG_VAT_ID_LABEL'),
			// 	'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_CATALOG_VAT_ID_PREFIX'),
			// 	'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ)),
			// 	'JS_VALUE' => array(
			// 		'type' => 'select',
			// 		'values' => $vatList
			...
			// 	'FIELD_TYPE' => 'char',
			// 	'LABEL' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_CATALOG_VAT_INCLUDED_LABEL'),
			// 	'PREFIX' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_CATALOG_VAT_INCLUDED_PREFIX'),
			// 	'LOGIC' => static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ)),
			// 	'JS_VALUE' => array(
			// 		'type' => 'select',
			// 		'values' => array(
			// 			'Y' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_CATALOG_VAT_INCLUDED_VALUE_YES'),
			// 			'N' => Loc::getMessage('AS_MOD_CATALOG_COND_CMP_CATALOG_VAT_INCLUDED_VALUE_NO')
			// 		)
			// 	),
			// 	'PHP_VALUE' => array(
			// 		'VALIDATE' => 'list'
				...
				switch ($arControl['FIELD_TYPE'])
				{
					...
					case 'datetime':
						...
						else
						{
							...
							if (!(AS_COND_LOGIC_EQ == $arLogic['ID'] || AS_COND_LOGIC_NOT_EQ == $arLogic['ID']))
							{
								if ($useParent)
...
class CCatalogCondCtrlIBlockProps extends CCatalogCondCtrlComplex
{
	...
	public static function GetControls($strControlID = false)
	{
		...
		$catalogId = $_POST['data']['iblockId'] ? $_POST['data']['iblockId'] : false;
		if($catalogId) {
			$arIBlockList[$catalogId] = true;
		}
					...
					while ($arProp = $rsProps->Fetch())
					{
						...
						if (isset($arProp['USER_TYPE']) && !empty($arProp['USER_TYPE']))
						{
							switch ($arProp['USER_TYPE'])
							{
								case 'DateTime':
									...
									$arLogic = static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ, AS_COND_LOGIC_GR, AS_COND_LOGIC_LS, AS_COND_LOGIC_EGR, AS_COND_LOGIC_ELS));
									$arValue = array(
										'type' => 'datetime',
										'format' => 'datetime'
									);
								...
								case 'directory':
									$strFieldType = 'text';
									$arLogic = static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ));
									$arValue = array(
										'type' => 'lazySelect',
										'load_url' => '/bitrix/tools/'.Solution::moduleID.'/customfilter_ajax.php',
										'load_params' => array(
						...
						if (!$boolUserType)
						{
							switch ($arProp['PROPERTY_TYPE'])
							{
								...
								case 'S':
									$strFieldType = 'text';
									$arLogic = static::GetLogic(array(AS_COND_LOGIC_EQ, AS_COND_LOGIC_NOT_EQ, AS_COND_LOGIC_CONT, AS_COND_LOGIC_NOT_CONT));
									$arValue = array('type' => 'input');
									break;
								case 'L':
									$strFieldType = 'int';
						...
						$arControlList['CondIBProp:'.$intIBlockID.':'.$arProp['ID']] = array(
							...
							'SEP_LABEL' => ($boolSep
								? str_replace(
									...
									Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_PROP_LABEL')
								)
								: ''
							),
							'LABEL' => $arProp['NAME'],
							'PREFIX' => str_replace(
								...
								Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_ONE_PROP_PREFIX')
							),
							'LOGIC' => $arLogic,
							'JS_VALUE' => $arValue,
	...
	public static function Check($arOneCondition, $arParams, $arControl, $boolShow)
	{
		...
		if ($boolShow)
		{
			...
			if (isset($result['err_cond_mess']))
				$result['err_cond_mess'] .= '. '.Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_PROPERTY_NOT_ACTIVE');
			else
				$result['err_cond_mess'] = Loc::getMessage('AS_MOD_CATALOG_COND_CMP_IBLOCK_PROPERTY_NOT_ACTIVE');
		}
		else
...
{
	protected $intMode = AS_COND_MODE_DEFAULT;			// work mode
	...
	{
		CJSCore::Init(array("aspro_core_condtree"));
	}
	...
	public function OnConditionControlBuildList()
	{
		...
		if (!empty($result))
		{
			...
			foreach ($result as $arRes)
			{
				...
				if (isset($arRes['ID']))
				{
					...
					{
						$this->arMsg[] = array('id' => 'CONTROLS', 'text' => str_replace('#CONTROL#', $arRes['ID'], Loc::getMessage('AS_MOD_COND_ERR_CONTROL_DOUBLE')));
						$this->boolError = true;
					}
					else
					{
					...
					if (isset($arRes['CONTROLS']) && !empty($arRes['CONTROLS']) && is_array($arRes['CONTROLS']))
					{
						...
						foreach ($arRes['CONTROLS'] as &$arOneControl)
						{
							if (isset($arOneControl['ID']))
							{
								...
								{
									$this->arMsg[] = array('id' => 'CONTROLS', 'text' => str_replace('#CONTROL#', $control['ID'], Loc::getMessage('AS_MOD_COND_ERR_CONTROL_DOUBLE')));
									$this->boolError = true;
								}
								else
								{
				...
				else
				{
					foreach ($arRes as &$arOneRes)
					{
						if (is_array($arOneRes) && isset($arOneRes['ID']))
						{
							...
							{
								$this->arMsg[] = array('id' => 'CONTROLS', 'text' => str_replace('#CONTROL#', $arOneRes['ID'], Loc::getMessage('AS_MOD_COND_ERR_CONTROL_DOUBLE')));
								$this->boolError = true;
							}
							else
							{
		...
		{
			$this->arMsg[] = array('id' => 'CONTROLS', 'text' => Loc::getMessage('AS_MOD_COND_ERR_CONTROLS_EMPTY'));
			$this->boolError = true;
		}
	}
	...
	protected function GetEventList($intEventID)
	{
		$arEventList = array(
			...
			AS_COND_BUILD_SALE_ACTIONS => array(
				'INTERFACE_ATOMS' => array(
					'MODULE_ID' => 'sale',
	...
	public function Init($intMode, $mxEvent, $arParams = array())
	{
		...
		{
			$this->boolError = true;
			$this->arMsg[] = array('id' => 'EVENT','text' => Loc::getMessage('AS_MOD_COND_ERR_EVENT_BAD'));
		}
		else
		{
		...
		if (AS_COND_MODE_DEFAULT == $this->intMode)
		{
			if (!empty($arParams) && is_array($arParams))
			{
			...
			if (empty($this->strJSName))
			{
				...
				{
					$this->boolError = true;
					$this->arMsg[] = array('id' => 'JS_NAME','text' => Loc::getMessage('AS_MOD_COND_ERR_JS_NAME_BAD'));
				}
				else
				{
		...
		if (AS_COND_MODE_DEFAULT == $this->intMode || AS_COND_MODE_PARSE == $this->intMode)
		{
			if (!empty($arParams) && is_array($arParams))
			{
	...
	public function Show($arConditions)
	{
		...
		if (!$this->boolError)
		{
			if (!empty($arConditions))
			{
				if (!is_array($arConditions))
				{
					...
					{
						$this->boolError = true;
						$this->arMsg[] = array('id' => 'CONDITIONS', 'text' => Loc::getMessage('AS_MOD_COND_ERR_SHOW_DATA_UNSERIALIZE'));
					}
					else
					{
						$arConditions = Solution::unserialize($arConditions);
						if (!is_array($arConditions))
						{
							$this->boolError = true;
							$this->arMsg[] = array('id' => 'CONDITIONS', 'text' => Loc::getMessage('AS_MOD_COND_ERR_SHOW_DATA_UNSERIALIZE'));
		...
		if (!$this->boolError)
		{
			...
			$strResult .= 'var '.$this->strJSName.' = new BX.AsTreeConditions('."\n";
	...
	public function Parse($arData = '', $arParams = false)
	{
		...
		if (!$this->boolError)
		{
			if (empty($arData) || !is_array($arData))
			{
				...
				{
					$this->boolError = true;
					$this->arMsg[] = array('id' => 'CONDITIONS', 'text' => Loc::getMessage('AS_MOD_COND_ERR_PARSE_DATA_EMPTY'));
				}
			}
		}
		...
		if (!$this->boolError)
		{
			foreach ($arData as $strKey => $value)
			{
				...
				{
					$this->boolError = true;
					$this->arMsg[] = array('id' => 'CONDITIONS', 'text' => Loc::getMessage('AS_MOD_COND_ERR_PARSE_DATA_BAD_KEY'));
					break;
				}
				...
				{
					$this->boolError = true;
					$this->arMsg[] = array('id' => 'CONDITIONS', 'text' => Loc::getMessage('AS_MOD_COND_ERR_PARSE_DATA_EMPTY_CONTROLID'));
					break;
				}
				...
				{
					$this->boolError = true;
					$this->arMsg[] = array('id' => 'CONDITIONS', 'text' => Loc::getMessage('AS_MOD_COND_ERR_PARSE_DATA_BAD_CONTROLID'));
					break;
				}
				...
				{
					$this->boolError = true;
					$this->arMsg[] = array('id' => 'CONDITIONS', 'text' => Loc::getMessage('AS_MOD_COND_ERR_PARSE_DATA_CONTROL_BAD_VALUE'));
					break;
				}
				...
				{
					$this->boolError = true;
					$this->arMsg[] = array('id' => 'CONDITIONS', 'text' => Loc::getMessage('AS_MOD_COND_ERR_PARSE_DATA_DOUBLE_KEY'));
					break;
				}
			}
		}
