...
$APPLICATION->SetPageProperty("description", "Весь спектр геодезических работ: от топосъемки 1:500 до межевания. Лицензия СРО. Выезд за 24ч, цены от 8000₽. Гарантия приемки документов в Росреестре и ИСОГД.");
$APPLICATION->SetPageProperty("title", "Геодезические услуги в Москве и МО: цены на изыскания и кадастр 2026");
